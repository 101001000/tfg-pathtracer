...
\item Se separa el conjunto de triángulos en dos subconjuntos disjuntos. El cómo se divide este conjunto se delega a la función \code{divideSAH()}, que hará uso de la heurística de superficie de área para decidir que triángulos van a cada subconjunto.
